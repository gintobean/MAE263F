...
% m1 - first material director (ne x 3)
% m2 - first material director (ne x 3)
% ctime - current time in seconds

%Outputs:
%Plot of nodes and edges, material directors, time-parallel reference
%directors, and current time.
